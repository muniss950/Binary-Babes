...
def main():
    ...
    hand_connection_drawing_spec = mp_drawing.DrawingSpec(thickness=4, circle_radius=4)
    pic_no = 0
    ...
    while cap.isOpened():
        ...
        if len(contours) > 0:
            ...
            cv2.putText(image, str(chord_dict[pred_class]), (x1 + 50, y1 - 50), cv2.FONT_HERSHEY_SIMPLEX, 2, (255, 0, 0), 5)
